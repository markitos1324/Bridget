...
public class pnButtonsMale extends JPanel{
	...
	private String selecSex = ConstantUI.NAME_SEX_MEN;
	private String selecLuggage = ConstantUI.NAME_LUGGAGE;
	private boolean isSelect = true;

	public pnButtonsMale(Controller controller) {
		setLayout(new GridLayout(4, 2, 10,10));

		btChildLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_CHILD_LUGGAGE)));
		btChildLuggage.setName(ConstantUI.NAME_CHILD_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
		...
		btChildNotLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_CHILD_NOT_LUGGAGE)));
		btChildNotLuggage.setName(ConstantUI.NAME_CHILD_NOT_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
		...
		btYoungLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_YOUNG_LUGGAGE)));
		btYoungLuggage.setName(ConstantUI.NAME_YOUNG_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
		...
		btYoungNotLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_YOUNG_NOT_LUGGAGE)));
		btYoungNotLuggage.setName(ConstantUI.NAME_YOUNG_NOT_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
		...
		btMenLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_MEN_LUGGAGE)));
		btMenLuggage.setName(ConstantUI.NAME_MEN_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
		...
		btMenNotLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_MEN_NOT_LUGGAGE)));
		btMenNotLuggage.setName(ConstantUI.NAME_MEN_NOT_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
		...
		btOldLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_OLD_LUGGAGE)));
		btOldLuggage.setName(ConstantUI.NAME_OLD_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
		...
		btOldNotLuggage = new JButton(new ImageIcon(getClass().getResource(ConstantUI.IMG_MEN_OLD_NOT_LUGGAGE)));
		btOldNotLuggage.setName(ConstantUI.NAME_OLD_NOT_LUGGAGE + "-" + ConstantUI.NAME_SEX_MEN);
